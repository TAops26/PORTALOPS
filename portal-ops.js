...
function renderChecklistCasitaMT_() {
  ...
  return `<div style="font-size:.7rem;text-transform:uppercase;letter-spacing:.1em;color:rgba(232,226,209,0.5);font-family:var(--font-sans);margin-bottom:.75rem;">Checklist de Inspección</div>
    ${items.map(item=>`<div class="cl-item" style="border-bottom:1px solid rgba(232,226,209,0.06);padding:.5rem 0;"><div style="width:20px;height:20px;border:1.5px solid rgba(153,92,68,.3);border-radius:5px;flex-shrink:0;margin-top:.1rem;"></div><div style="font-size:.82rem;font-family:var(--font-sans);color:rgba(232,226,209,0.85);line-height:1.4;margin-left:.75rem;">${escapeHtml(item)}</div></div>`).join('')}
